...
#####################################################################################
# PUT ONE red PIXEL
#### NEEDS AN IMAGE FROM USER
## takes argument from user and opens it
# img = Image.open( sys.argv[1] )
# ## coordinates have to be put in (), they are the coordinates for the rbg value
# one_pixel = img.getpixel( (0,0) )
# ## variable is one_pixel (made up) and saying get pixel 0,0 from the image inputted
# print(one_pixel)
# ## prints color value (hex) of that pixel that is coordinated
# ## this will put that specified pixel somewhere else, and second thiny is a color, hex code! rbg (red)
# img.putpixel( (10,10), (255,0,0) )
# img.save("new.jpg")
## will be saved as newimage
...
# ## new kind of color space, hue saturation value
# img_hsv_data = img_hsv.getdata()

# ## from here basically rebuilding the image
# new_img_data = []
# ## making own new empty list out of a large list and pushing into own new list
# #### useful for dividing data and focusing on certain part (filter)
# for p in img_hsv_data:
#     print(p)
#     ### can be used to make sure code is running with having something print
#     if p[2] < 55:
#         ### saying if image is less saturated than 55, .append or add to empty list, push this color value into empty list,
#         new_img_data.append( (255,255,255) )
#     else:
#         new_img_data.append(p)

# ## here is putting the image back together, put it into rbg and saving it
